...
const styles = `
    * {
    ...
    .code-header {
        ...
        align-items: center;
        gap: 12px;
        background: linear-gradient(135deg, #144e82 0%, #1e88e5 100%);
    ...
    .toast-info {
        background: linear-gradient(135deg, #1E88E5 0%, #F6C90E 100%);
        color: white;
    }
    ...
    .progress-fill {
        height: 100%;
        background: linear-gradient(90deg, #ddc55aff, #ffd000ff);
...
export function SessionCard() {
    ...
    const handleExportPDF = () => {
        addToast('Exporting to PDF... (Please install a PDF printer)', 'info');
    ...
    const handleReset = () => {
        if (window.confirm('Are you sure you want to reset all changes?')) {
            ...
            addToast('Session reset to original state', 'info');
        }
    };
                    ...
                    <div className="Section-Top">
                        ...
                        <div className="card-info">
                            <div className="info-item">
                                ...
                                <span className="value">{session?.studentName || 'N/A'}</span>
                            </div>
                            <div className="info-item">
                            ...
                            <div className={`technology-card ${expandedTechnology ? 'expanded' : 'collapsed'}`}>
                                {expandedTechnology ? (
                                    ...
                                    <>
                                        ...
                                        <div className="technology-collapsed-title">New Technology for Student</div>
                                        <button 
                                            className="btn-expand"
